  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-purple-100 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-gray-600 mb-8">AI Algorithm Visualizer</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Attributes ({selectedAttributes.length}/{config.attributes.length})
              </label>
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-lg p-6">
            {!result ? (
              <div className="flex flex-col items-center justify-center h-full text-gray-400">
                ...
                <p className="text-lg">Configure and run the solver to see visualization</p>
              </div>
            ) : (
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white p-6 rounded-lg">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-indigo-100">Secret: {result.secret_name}</p>
                    </div>
                    <div className="text-right">
                      <div className="text-3xl font-bold">{result.total_attempts}</div>
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-bold text-gray-800">Solution Steps</h4>
